...
import com.romzkie.tunnelpro.LauncherActivity;
		...
		SkStatus.StateListener
{
    ...
    public void onCreatePreferences(Bundle bundle, String root_key)
	{
		...
		Preference udpForwardPreference = (SwitchPreferenceCompat)
			...
			case MODO_NOTURNO_KEY:
                ...
                mHandler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            // reinicia app
                            Intent startActivity = new Intent(context, SocksHttpMainActivity.class);
